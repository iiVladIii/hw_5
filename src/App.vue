  ...
  <div id="app">
   <div class="app-title-1">Доходы и Расходы
    ...
    <div class="add" v-show="show"><br>
      ...
      Сумма: <input v-model="sum"  placeholder="Сумма"/><br>
      Дата:<input v-model="date" placeholder="Дата"/><br>
      Тип:
    ...
    <div :class="{income: classIncome1 , consumption: classConsumption1}" v-if="card1">
      <button style="margin-left: 170px" @click="edit1 =! edit1, rename(1)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div class="edit" v-if="edit1">
      ...
      Сумма: <input v-model="sum"  placeholder="sum"/><br>
      Дата: <input v-model="date" placeholder="date"/><br>
      Тип:
    ...
    <div :class="{income: classIncome2 , consumption: classConsumption2}" v-if="card2">
      <button style="margin-left: 170px" @click="edit2 =! edit2, rename(2)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome3 , consumption: classConsumption3}" v-if="card3">
      <button style="margin-left: 170px" @click="edit3 =! edit3, rename(3)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome4 , consumption: classConsumption4}" v-if="card4">
      <button style="margin-left: 170px" @click="edit4 =! edit4, rename(4)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome5 , consumption: classConsumption5}" v-if="card5">
      <button style="margin-left: 170px" @click="edit5 =! edit5, rename(5)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome6 , consumption: classConsumption6}" v-if="card6">
      <button style="margin-left: 170px" @click="edit6 =! edit6, rename(6)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome7 , consumption: classConsumption7}" v-if="card6">
      <button style="margin-left: 170px" @click="edit7 =! edit7, rename(7)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome8 , consumption: classConsumption8}" v-if="card8">
      <button style="margin-left: 170px" @click="edit8 =! edit8, rename(8)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome9 , consumption: classConsumption9}" v-if="card9">
      <button style="margin-left: 170px" @click="edit9 =! edit9, rename(9)"><img src="./assets/edit.png" height="30px" width="40px"></button>
    ...
    <div :class="{income: classIncome10 , consumption: classConsumption10}" v-if="card10">
      <button style="margin-left: 170px" @click="edit10 =! edit10, rename(10)"><img src="./assets/edit.png" height="30px" width="40px"></button>
